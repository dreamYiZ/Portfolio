  ...
  return (
    <div style={{ width: "100%", minHeight: "100vh", padding: "0 5%" }}>
      ...
      <Content>
        ...
        <p style={{ fontFamily: "'New Tegomin', serif", fontSize: "1.5rem" }}>
          I am a full stack Software Developer based in Berlin.
          <br /> My main passions are programming, new technologies, blockchain
          and martial arts.
        </p>
        ...
        >
          ...
          improvement. <br /> I am very driven and dedicated to everything I do.
        </p>
        <p style={{ fontFamily: "'New Tegomin', serif", fontSize: "1.5rem" }}>
